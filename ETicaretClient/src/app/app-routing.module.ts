...
const routes: Routes = [
  {
    path: "admin", component: LayoutComponent, children: [
      ...
      { path: "authorize-menu", loadChildren: () => import("./admin/components/authorize-menu/authorize-menu.module").then(module => module.AuthorizeMenuModule), canActivate: [AdminGuard] },
      { path: "roles", loadChildren: () => import("./admin/components/role/role.module").then(module => module.RoleModule), canActivate: [AdminGuard] },
      { path: "users", loadChildren: () => import("./admin/components/user/user.module").then(module => module.UserModule), canActivate: [AdminGuard] },
  ...
  { path: "my-orders", loadChildren: () => import("./ui/components/orders-page/orders-page.module").then(m => m.OrdersPageModule), canActivate: [AuthGuard] }
];
